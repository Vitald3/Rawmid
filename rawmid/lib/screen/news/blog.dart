                                                                                ...
                                                                                children: [
                                                                                  ...
                                                                                  ElevatedButton(
                                                                                      ...
                                                                                      onPressed: () {
                                                                                        ...
                                                                                        Get.put(NewsController(controller.featured[index].id, false));
                                                                                        Get.to(() => NewsView());
                                                                                      },
                                      ...
                                      children: [
                                        Expanded(
                                            child: Container(
                                                ...
                                                child: NewsCard(news: controller.news[first], recipe: controller.isRecipe.value)
                                            )
                                        ),
                                        Expanded(
                                            child: second != null ? Container(
                                                constraints: BoxConstraints(maxHeight: 264, minHeight: 260),
                                                child: NewsCard(news: controller.news[second], recipe: controller.isRecipe.value)
                                            ) : SizedBox()
                                        )
                                      ]
                                  )
